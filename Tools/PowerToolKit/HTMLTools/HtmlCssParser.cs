...
namespace JISoft.HTMLTools
{
    ...
    internal static class HtmlCssParser
    {
        ...
        internal static void GetElementPropertiesFromCssAttributes(XElement htmlElement, string elementName, CssStylesheet stylesheet, Dictionary<Object, Object> localProperties, List<XElement> sourceContext)
        {
        ...
        private static void ParseWordEnumeration(string[] words, string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties, string attributeName)
        {
        ...
        private static string ParseCssSize(string styleValue, ref int nextIndex, bool mustBeNonNegative)
        {
            ...
            if (_fontAbsoluteSizes.ContainsKey(styleValue)) 
            {
                return _fontAbsoluteSizes[styleValue];
            }
            return null;
        }

        private static void ParseCssSize(string styleValue, ref int nextIndex, Dictionary<Object,Object> localValues, string propertyName, bool mustBeNonNegative)
        {
        ...
        private static string ParseCssColor(string styleValue, ref int nextIndex)
        {
            ...
            if (nextIndex < styleValue.Length)
            {
                ...
                else if (styleValue.Length >= nextIndex+3 && styleValue.Substring(nextIndex, 3).ToLower() == "rbg")
                {
        ...
        private static void ParseCssColor(string styleValue, ref int nextIndex, Dictionary<Object,Object> localValues, string propertyName)
        {
        ...
        private static readonly Dictionary<string,string> _fontAbsoluteSizes = new Dictionary<string,string>() {
            {"xx-small","14"}, {"x-small","18.667"}, {"small","20"}, {"medium","22.667"}, {"large","32"}, {"x-large","42.667"}, {"xx-large","72"} };
        ...
        private static void ParseCssFont(string styleValue, Dictionary<Object,Object> localProperties)
        {
            int nextIndex = 0;
        ...
        private static void ParseCssFontStyle(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
            ParseWordEnumeration(_fontStyles, styleValue, ref nextIndex, localProperties, "font-style");
        }

        private static void ParseCssFontVariant(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
            ParseWordEnumeration(_fontVariants, styleValue, ref nextIndex, localProperties, "font-variant");
        }

        private static void ParseCssFontWeight(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
            ParseWordEnumeration(_fontWeights, styleValue, ref nextIndex, localProperties, "font-weight");
        }

        private static void ParseCssFontFamily(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
        ...
        private static void ParseCssListStyle(string styleValue, Dictionary<Object,Object> localProperties)
        {
            int nextIndex = 0;
        ...
        private static void ParseCssTextDecoration(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
        ...
        private static void ParseCssTextTransform(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
        ...
        private static void ParseCssTextAlign(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
        ...
        private static void ParseCssVerticalAlign(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
        ...
        private static void ParseCssFloat(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
        ...
        private static void ParseCssClear(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
        ...
        private static bool ParseCssRectangleProperty(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties, string propertyName)
        {
            // CSS Spec: 
        ...
        private static void ParseCssBorder(string styleValue, ref int nextIndex, Dictionary<Object,Object> localProperties)
        {
            while (
        ...
        private static void ParseCssBackground(string styleValue, ref int nextIndex, Dictionary<Object,Object> localValues)
        {
    ...
    internal class CssStylesheet
    {
        ...
        public void DiscoverStyleDefinitions(XElement htmlElement)
        {
            ...
            for (XNode htmlChildNode = htmlElement.FirstNode; htmlChildNode != null; htmlChildNode = htmlChildNode.NextNode)
            {
                if (htmlChildNode is XText || htmlChildNode is XComment)
                {
                    var value = htmlChildNode is XText? (htmlChildNode as XText).Value : (htmlChildNode as XComment).Value;
                    stylesheetBuffer.Append(RemoveComments(value));
                }
            }
        ...
        public string GetStyle(string elementName, List<XElement> sourceContext)
        {
            ...
            Debug.Assert(elementName == sourceContext[sourceContext.Count - 1].Name.LocalName.ToLower());
        ...
        private bool MatchSelectorLevel(string selectorLevel, XElement xmlElement)
        {
            ...
            if (selectorTag != null && selectorTag != xmlElement.Name.LocalName.ToLower())
            {
                return false;
            }
