...
namespace JISoft.HTMLTools
{
    ...
    internal class HtmlSchema
    {
        ...
        /// <summary>
        /// static constructor, initializes the List<string> s
        ...
        {
            _htmlInlineElements = new List<string> ();
        ...
        {
            _htmlBlockElements = new List<string>();
        ...
        private static void InitializeEmptyElements()
        {
            ...
            _htmlEmptyElements = new List<string> ();
        ...
        private static void InitializeOtherOpenableElements()
        {
            ...
            // elements during html parsing, and adding the
            // to a tree produced by html parser.
            _htmlOtherOpenableElements = new List<string> ();
        ...
        {
            _htmlElementsClosingOnParentElementEnd = new List<string> ();
        ...
        {
            _htmlElementsClosingColgroup = new List<string> ();
            ...
            _htmlElementsClosingDD = new List<string> ();
            ...
            _htmlElementsClosingTD = new List<string> ();
            ...
            _htmlElementsClosingTH = new List<string> ();
            ...
            _htmlElementsClosingThead = new List<string> ();
            _htmlElementsClosingThead.Add("tbody");
            _htmlElementsClosingThead.Add("tfoot");
            // TODO: more complex recovery

            _htmlElementsClosingTfoot = new List<string> ();
        ...
        private static IList _htmlInlineElements;

        private static IList _htmlBlockElements;

        private static IList _htmlOtherOpenableElements;

        // list of html empty element names
        private static IList _htmlEmptyElements;

        // names of html elements for which closing tags are optional, and close when the outer nested element closes
        private static IList _htmlElementsClosingOnParentElementEnd;
        ...
        private static IList _htmlElementsClosingColgroup;

        // names of elements closing the dd element
        private static IList _htmlElementsClosingDD;

        // names of elements closing the dt element
        private static IList _htmlElementsClosingDT;

        // names of elements closing the li element
        private static IList _htmlElementsClosingLI;

        // names of elements closing the tbody element
        private static IList _htmlElementsClosingTbody;

        // names of elements closing the td element
        private static IList _htmlElementsClosingTD;

        // names of elements closing the tfoot element
        private static IList _htmlElementsClosingTfoot;

        // names of elements closing the thead element
        private static IList _htmlElementsClosingThead;

        // names of elements closing the th element
        private static IList _htmlElementsClosingTH;

        // names of elements closing the tr element
        private static IList _htmlElementsClosingTR;

        // html character entities hashtable
        private static Dictionary<string, char> _htmlCharacterEntities;
