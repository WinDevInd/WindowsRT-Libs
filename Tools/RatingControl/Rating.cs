//----------------------------------------------------------------------------------------------
// <copyright file="Rating.cs" company="JISoft" Owner="Microsoft">
// Taken from Microsoft phone toolkit for Windows Phone 8.0 and Migrated to WinRT apps
// MS-Pl licensed
// </copyright>
//-------------------------------------------------------------------------------------------------
...
namespace JISoft.RatingControl
{
    /// <summary>
    ...
    public class Rating : Control
    {
        ...
        public Rating()
        {
            ...
            this.ManipulationStarted += Rating_ManipulationStarted;
            this.ManipulationDelta += Rating_ManipulationDelta;
        ...
        void Rating_ManipulationStarted(object sender, ManipulationStartedRoutedEventArgs e)
        {
            if (!ReadOnly)
            {
                PerformValueCalculation(e.Position, e.Container);
                UpdateDragHelper();
                System.Diagnostics.Debug.WriteLine("Manipulation Start Called");
            }
        }

        void Rating_ManipulationDelta(object sender, ManipulationDeltaRoutedEventArgs e)
        {
            if (!ReadOnly)
            {
                PerformValueCalculation(e.Position, e.Container);
                UpdateDragHelper();
                System.Diagnostics.Debug.WriteLine("Manipulation Delta Called");
        ...
        private void OnManipulationCompleted(object sender, ManipulationCompletedRoutedEventArgs e)
        {
            ...
            {
                PerformValueCalculation(e.Position, e.Container);
                System.Diagnostics.Debug.WriteLine("Manipulation Complete Called");
            }
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (_filledClipElement != null)
            {
                ...
                _filledClipElement.Clip = _clippingMask as RectangleGeometry;
            }
            ...
            bool isg = VisualStateManager.GoToState(this, "Collapsed", false);
            SynchronizeGrids();
        }
        ...
        public static readonly DependencyProperty FilledItemStyleProperty =
            ...
            typeof(Style), typeof(Rating), new PropertyMetadata(null,
            new PropertyChangedCallback(OnFilledItemStyleChanged)));
        ...
        public static readonly DependencyProperty UnfilledItemStyleProperty =
            ...
            new PropertyMetadata(null, new PropertyChangedCallback(OnUnfilledItemStyleChanged)));
        ...
        public static readonly DependencyProperty RatingItemCountProperty =
            DependencyProperty.Register("RatingItemCount",
                ...
                new PropertyMetadata(0, OnRatingItemCountChanged));
        ...
        /// </summary>
        private bool AllowHalfItemIncrement
        {
